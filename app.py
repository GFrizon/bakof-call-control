...
SECRET_KEY = os.getenv("SECRET_KEY", "troque-esta-chave")   #Demonstração GITHUB
...
MAIL_DEFAULT_NAME = os.getenv("MAIL_DEFAULT_NAME", "gabriel.teste@frizon.com.br") #Demonstração GITHUB
MAIL_DEFAULT_FROM = os.getenv("MAIL_DEFAULT_FROM", "gabriel.teste@frizon.com.br") #Demonstração GITHUB
    "MAIL_RECIPIENTS",
    "gabriel.teste@frizon.com.br"                           #Demonstração GITHUB
).split(",") if e.strip()]
